...
const LABELS: Record<string, string> = {
  ...
  representative_firm: "Representative's firm",
  representative_phone: "Representative phone",
  servicing_bankruptcy_status: "Bankruptcy status (servicing)",
  servicing_status_source: "Status source",
  servicing_status_imported_at: "Status imported",
  specialist_determination: "Specialist determination",
  bankruptcy_case_number: "Bankruptcy case number",
  bankruptcy_chapter: "Chapter",
  bankruptcy_court: "Bankruptcy court",
  bankruptcy_filed_date: "Case filed",
  dismissed_date: "Case dismissed",
  discharge_entered: "Discharge entered",
