...
| DEMO-04 | Gregory P. Lindqvist's Harbor Point loan, disputed by his attorney Monica A. Ferrante (Ferrante & Hale, LLC): the order dismissing Chapter 13 case No. 24-10382 on July 14, 2026 without a discharge conflicts with the “discharged” marker from an unverified August 3 import; her signed authorization makes contact representative-only; existing pending Bankruptcy Team task. See the [use-case pack](../usecases/demo-4-bankruptcy-dispute/README.md) | `followup`: the Bankruptcy Team determination `BK-REV-260922-004` (internal memo) confirms the dismissal and corrects the marker; credit reporting is referred to Compliance; the restriction remains |
